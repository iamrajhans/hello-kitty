...
output "aws_s3_kitty_blr_stackgen_1_arn" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.arn
  sensitive = false
}


output "aws_s3_kitty_blr_stackgen_1_bucket_name" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_name
  sensitive = false
}


output "aws_s3_kitty_blr_stackgen_1_bucket_website_endpoint" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_website_endpoint
  sensitive = false
}


output "aws_s3_kitty_blr_stackgen_1_kms_arn" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.kms_arn
  sensitive = false
}


output "aws_iam_role_hello_kitty_role_kitty_stackgen_1_arn" {
  value = module.appcd_b71fd16c-797e-5a95-8e1b-ab22f1e34f43.arn
  sensitive = false
}


output "aws_iam_role_hello_kitty_role_kitty_stackgen_1_name" {
  value = module.appcd_b71fd16c-797e-5a95-8e1b-ab22f1e34f43.name
  sensitive = false
}


output "aws_cloudwatch_log_group_aws_lambda_hello_kitty_function_stackgen_83_arn" {
  value = module.appcd_86ec452a-770a-59bf-87dd-67ed883e25e5.arn
  sensitive = false
}


output "aws_cloudwatch_log_group_aws_lambda_hello_kitty_function_stackgen_83_name" {
  value = module.appcd_86ec452a-770a-59bf-87dd-67ed883e25e5.name
  sensitive = false
}


output "aws_lambda_hello_kitty_function_blr_stackgen_1_function_url" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_url
  sensitive = false
}


output "aws_lambda_hello_kitty_function_blr_stackgen_1_invoke_arn" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.invoke_arn
  sensitive = false
}


output "aws_lambda_hello_kitty_function_blr_stackgen_1_function_arn" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_arn
  sensitive = false
}


output "aws_lambda_hello_kitty_function_blr_stackgen_1_function_name" {
